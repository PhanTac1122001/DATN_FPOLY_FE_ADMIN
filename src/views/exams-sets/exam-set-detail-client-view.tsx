...
import type { ExamSetDetailClientViewProps } from "@/types/exam-set.types";
import { ExamSetDetailView } from "./exam-set-detail-view";

export function ExamSetDetailClientView({ id }: ExamSetDetailClientViewProps) {
