...
import { TOOLTIP_CROSS_OFFSET, TOOLTIP_DEFAULT_DELAY, TOOLTIP_DEFAULT_OFFSET } from "@/constants/base-components.constants";
import type { TooltipProps, TooltipTriggerProps } from "@/types/base-components.types";
...
export const Tooltip = ({
    ...
    const calculatedCrossOffset = isTopOrBottomLeft ? -TOOLTIP_CROSS_OFFSET : isTopOrBottomRight ? TOOLTIP_CROSS_OFFSET : 0;
        ...
        <AriaTooltipTrigger {...{ trigger, delay, closeDelay, isDisabled, isOpen, defaultOpen, onOpenChange }}>
            ...
            >
                {({ isEntering, isExiting }) => (
                    ...
                    >
                        <span className="text-xs font-semibold break-all text-white">{title}</span>
