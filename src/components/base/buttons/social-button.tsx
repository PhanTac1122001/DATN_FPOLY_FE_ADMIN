...
import type { SocialButtonProps } from "@/types/base-components.types";
...
export const styles = sortCx({
    ...
    colors: {
        ...
        facebook: {
            root: "bg-[var(--social-facebook)] text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0% hover:bg-[var(--social-facebook-hover)]",
            icon: "",
        },

        dribble: {
            root: "bg-[var(--social-dribbble)] text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0% hover:bg-[var(--social-dribbble-hover)]",
            icon: "",
        },
    },
});
...
export type { SocialButtonCommonProps, SocialButtonButtonProps, SocialButtonLinkProps, SocialButtonProps } from "@/types/base-components.types";
