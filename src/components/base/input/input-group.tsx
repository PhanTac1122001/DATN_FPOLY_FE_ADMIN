...
import type { InputGroupProps, InputPrefixProps } from "@/types/base-components.types";
import { cx, sortCx } from "@/utils/cx";

// Re-export types from centralized location
export type { InputPrefixProps, InputGroupProps } from "@/types/base-components.types";
