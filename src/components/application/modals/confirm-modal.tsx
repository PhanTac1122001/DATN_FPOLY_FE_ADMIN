                    ...
                    <div className="mt-5 flex w-full items-center justify-center gap-3">
                        {cancelText && (
                            <button
                                ...
                                onClick={onClose}
                                disabled={isLoading}
                                className="w-1/3 cursor-pointer justify-center !rounded-full border border-slate-200 bg-white py-2.5 text-center text-xs font-bold text-slate-700 transition-all duration-150 hover:bg-slate-50 hover:text-slate-900 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
                            >
                                {cancelText}
                            </button>
                        )}
