...
import { LOADING_INDICATOR_STYLES } from "@/constants/application.constants";
import type { LoadingIndicatorProps } from "@/types/application.types";
import { cx } from "@/utils/cx";

export const LoadingIndicator = ({ type = "line-spinner", size = "sm", label }: LoadingIndicatorProps) => {
    const styles = LOADING_INDICATOR_STYLES;
    const renderSpinner = () => {
